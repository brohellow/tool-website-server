...
const Chat = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900">
      <div className="max-w-6xl mx-auto px-4 pt-20 pb-6 h-screen">
        <div className="bg-dark-700/50 backdrop-blur-sm rounded-2xl border border-dark-600 shadow-xl overflow-hidden flex flex-col h-full">
